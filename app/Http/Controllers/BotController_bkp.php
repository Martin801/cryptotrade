...
class BotController extends Controller
{
    ...
    public function britex_bot()
    {
        ...
        $this->criptopia_buy_bot();
        $this->criptopia_sell_bot();
...
$get_buy_data = $this->bittrex_sell($get_user_details[0]->api_key,$get_user_details[0]->api_secret,$get_result['result'][0]['MarketName'],$qty,$get_result['result'][0]['Bid']);
...
$subject = "Bitcoin Trading Bot SELL BITREX";
$message = "SELL <b>".$value->currency_to_spend_earn."</b> WITH <b>".$value->currency."</b> QTY <b>".$value->qty."</b> ASK PRICE <b>".$get_result['result'][0]['Bid']." <b>";
...
mail ($to,$subject,$message,$header);
    ...
    public function bitrex_buy_bot()
    {
        ...
        $get_buy_data = $this->bittrex_buy($get_user_details[0]->api_key,$get_user_details[0]->api_secret,$get_result['result'][0]['MarketName'],$qty,$get_result['result'][0]['Ask']);
        ...
        $to = "aquadevjd@gmail.com";
        $subject = "Bitcoin Trading Bot BUY BITREX";

        $message = "BUY <b>".$value->currency."</b> WITH <b>".$value->currency_to_spend_earn."</b> QTY <b>".$value->qty."</b> ASK PRICE <b>".$get_result['result'][0]['Ask']." <b>";
...
// CRYTOPIA
    ...
    public function cryptopia_buy_sell($apikey,$apisecret,$type,$qty,$amount,$market)
    {
        if(!empty($apikey) && !empty($apisecret)){

        $nonce = microtime(time());

        $req = array('Market'=> $market, 'Type'=> $type, 'Rate'=> $qty, 'Amount'=> $amount) ;
    ...
    public function criptopia_buy_bot()
    {
        ...
        $get_buy_data = $this->cryptopia_buy_sell($get_user_details[0]->api_key,$get_user_details[0]->api_secret,'Buy',$value->qty,$get_result['Data']['AskPrice'],$get_result['Data']['Label']);
        ...
        $to = "aquadevjd@gmail.com";
        $subject = "Bitcoin Trading Bot BUY CRYTOPIA";

        $message = "BUY <b>".$value->currency."</b> WITH <b>".$value->currency_to_spend_earn."</b> QTY <b>".$value->qty."</b> ASK PRICE <b>".$get_result['Data']['AskPrice']." <b>";
...
if(!empty($value->qty)){
$get_buy_data = $this->cryptopia_buy_sell($get_user_details[0]->api_key,$get_user_details[0]->api_secret,'Sell',$value->qty,$get_result['Data']['BidPrice'],$get_result['Data']['Label']);
$get_id = DB::table('robot_tradess')->insertGetId([
'user_id' => $value->user_id,
'bot_id' => $value->id,
'exchange_id' => $value->exchange_id,
...
$to = "aquadevjd@gmail.com";
$subject = "Bitcoin Trading Bot SELL CRYTOPIA";
$message = "SELL <b>".$value->currency_to_spend_earn."</b> WITH <b>".$value->currency."</b> QTY <b>".$value->qty."</b> ASK PRICE <b>".$get_result['Data']['BidPrice']." <b>";
$header  = "From:aquadevjd@gmail.com \r\n";
$header .= "Cc:aquadevjd@gmail.com \r\n";
$header .= "MIME-Version: 1.0\r\n";
$header .= "Content-type: text/html\r\n";
...
if(!empty($value->qty_limit)){
$get_buy_data = $this->cryptopia_buy_sell($get_user_details[0]->api_key,$get_user_details[0]->api_secret,'Sell',$value->qty_limit,$get_result['Data']['BidPrice'],$get_result['Data']['Label']);
$get_id = DB::table('robot_tradess')->insertGetId([
'user_id' => $value->user_id,
'bot_id' => $value->id,
'exchange_id' => $value->exchange_id,
...
if(!empty($value->qty_stop_loss_one)){
$get_buy_data = $this->cryptopia_buy_sell($get_user_details[0]->api_key,$get_user_details[0]->api_secret,'Sell',$value->qty_stop_loss_one,$get_result['Data']['BidPrice'],$get_result['Data']['Label']);
$get_id = DB::table('robot_tradess')->insertGetId([
'user_id' => $value->user_id,
'bot_id' => $value->id,
'exchange_id' => $value->exchange_id,
...
if(!empty($value->qty_stop_loss_two)){
$get_buy_data = $this->cryptopia_buy_sell($get_user_details[0]->api_key,$get_user_details[0]->api_secret,'Sell',$value->qty_stop_loss_two,$get_result['Data']['BidPrice'],$get_result['Data']['Label']);
$get_id = DB::table('robot_tradess')->insertGetId([
'user_id' => $value->user_id,
'bot_id' => $value->id,
'exchange_id' => $value->exchange_id,
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    public function yobit_buy_bot()
    {
        ...
        if($value_one['type'] == 'ask'){

        $get_buy_data = $this->yobit_buy_sell($get_user_details[0]->api_key,$get_user_details[0]->api_secret,$get_market_name,'buy',$value_one['price'],$value->qty);
        ...
        $to = "aquadevjd@gmail.com";
        $subject = "Bitcoin Trading Bot BUY YOBIT";

        $message = "BUY <b>".$value->currency."</b> WITH <b>".$value->currency_to_spend_earn."</b> QTY <b>".$value->qty."</b> ASK PRICE <b>".$value_one['price']." <b>";
